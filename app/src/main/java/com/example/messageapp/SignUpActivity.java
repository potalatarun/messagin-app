...
import com.example.messageapp.Models.Users;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding.btnSignUp.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(!binding.txtUsername.getText().toString().isEmpty() && !binding.txtEmail.getText().toString().isEmpty() && !binding.txtPassword.toString().isEmpty()){
                    progressDialog.show();
